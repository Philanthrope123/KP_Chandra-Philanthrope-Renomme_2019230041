...
Public Class Form2
    ...
    Private Sub ComboBox2_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox2.SelectedIndexChanged
        Call koneksi()
        cmd = New MySqlCommand("Select * from tbl_master where NISN='" & ComboBox2.Text & "'", con)
        rd = cmd.ExecuteReader
        rd.Read()
        If rd.HasRows Then
            TextBox5.Text = rd!Nama_Siswa
    ...
    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        ...
        Else
            ...
            Dim simpan As String
            MsgBox("Data Berhasil Di Simpan")
            simpan = "insert into tbl_absensi values('" & tglsaya & "','" &
           Me.ComboBox2.Text & "','" & Me.TextBox5.Text & "','" & Me.TextBox4.Text & "','" & Me.TextBox7.Text & "','" & Me.ComboBox3.Text & "')"
            cmd = New MySqlCommand(simpan, con) ' untuk menghubungkan ke database dan table lalu simpan
            cmd.ExecuteNonQuery() ' mengeksekusi datanya
            nomor()
            tampil_data_absen()
